...
import (
	...
	"github.com/radutopala/webdriver/log"
)
...
func testChromeExtension(t *testing.T, c config) {
	...
	if err != nil {
		t.Fatalf("NewRemote(%+v) returned error: %v", caps, err)
	}
	defer wd.Quit()
...
func TestDocker(t *testing.T) {
	...
	args := []string{"build", "-t", "webdriver", "testing/"}
	...
	// passed to go test.
	cmd := exec.Command("docker", "run", fmt.Sprintf("--volume=%s:/code", pathToMount), "--workdir=/code/src/github.com/radutopala/webdriver", "webdriver", "testing/docker-test.sh")
	if testing.Verbose() {
...
func testTitle(t *testing.T, c config) {
	...
	expectedTitle := "Go WebDriver Test Suite"
...
func testKeyDownUp(t *testing.T, c config) {
	...
	if err := wd.KeyDown(ControlKey); err != nil {
		t.Errorf("error pressing control key down: %v", err)
	}
...
func testProxy(t *testing.T, c config) {
	...
	if !strings.Contains(source, pageContents) {
		if strings.Contains(source, "Go WebDriver Test Suite") {
...
<html>
<head>
	<title>Go WebDriver Test Suite</title>
</head>
<body>
	The home page. <br />
	<form action="/search">
...
<html>
<head>
	<title>Go WebDriver Test Suite - Other Page</title>
</head>
<body>
	The other page.
</body>
...
<html>
<head>
	<title>Go WebDriver Test Suite - Search Page</title>
</head>
<body>
...
<html>
<head>
	<title>Go WebDriver Test Suite - Log Page</title>
	<script>
...
<html>
<head>
	<title>Go WebDriver Test Suite - Frame Page</title>
</head>
<body>
...
<html>
<head>
	<title>Go WebDriver Test Suite - Title Change Page</title>
</head>
<body>
